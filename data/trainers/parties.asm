...
FalknerGroup:
	...
	db 12, NATU,      BERRY, PECK, LEER, SHADOW_SNEAK, NO_MOVE
	db 12, PIDGEOTTO, BERRY, MUD_SLAP, SAND_ATTACK, GUST, PURSUIT
	db 14, NOCTOWL,   BERRY, PECK, MUD_SLAP, CONFUSION, GROWL
	db -1 ; end

WhitneyGroup:
	; WHITNEY (1)
	db "WHITNEY@", TRAINERTYPE_ITEM_MOVES
	db 21, JIGGLYPUFF,   BERRY, ICE_PUNCH, SING, DEFENSE_CURL, DOUBLESLAP
	db 21, TEDDIURSA,    BERRY, FURY_SWIPES, LEER, LICK, ROCK_SMASH 
	db 24, MILTANK,    MIRACLEBERRY, ROLLOUT, ATTRACT, STOMP, MILK_DRINK
	db -1 ; end

BugsyGroup:
	; BUGSY (1)
	db "BUGSY@", TRAINERTYPE_ITEM_MOVES
	db 18, PINECO,   BERRY,  SELFDESTRUCT, PIN_MISSILE, RAPID_SPIN, NO_MOVE
	db 18, LEDIAN,   BERRY,  LIGHT_SCREEN, REFLECT, MACH_PUNCH, THUNDERPUNCH
	db 21, SCYTHER,  BERRY,  QUICK_ATTACK, SWORDS_DANCE, FURY_CUTTER, CUT
	db -1 ; end

MortyGroup:
	; MORTY (1)
	db "MORTY@", TRAINERTYPE_ITEM_MOVES
	db 26, HAUNTER,    BERRY, HYPNOSIS, HEX, CURSE, SHADOW_BALL
	db 26, STANTLER,   BERRY, HYPNOSIS, STOMP, SHADOW_BALL, DREAM_EATER
	db 28, MISDREAVUS, SPELL_TAG, PSYBEAM, SHADOW_BALL, PERISH_SONG, HEX
	db 29, GENGAR,     MIRACLEBERRY, HYPNOSIS, SHADOW_BALL, DREAM_EATER, NASTY_PLOT
	db -1 ; end

PryceGroup:
	; PRYCE (1)
	db "PRYCE@", TRAINERTYPE_ITEM_MOVES
	db 36, DELIBIRD,   GOLD_BERRY, PRESENT, ICE_PUNCH, AMNESIA, RECOVER
	db 36, DEWGONG,    GOLD_BERRY, HEADBUTT, ICY_WIND, ICE_BEAM, REST
	db 36, JYNX,       GOLD_BERRY, LOVELY_KISS, CONFUSION, BLIZZARD, NASTY_PLOT
	db 37, SNEASEL,    GOLD_BERRY, ICE_PUNCH, FAINT_ATTACK, SWORDS_DANCE, ROCK_SMASH
	db 38, PILOSWINE,  NEVERMELTICE, ICY_WIND, FURY_ATTACK, DIG, BLIZZARD
	db -1 ; end

JasmineGroup:
	; JASMINE (1)
	db "JASMINE@", TRAINERTYPE_ITEM_MOVES
	db 34, MAGNETON,  BERRY, THUNDERBOLT, SUPERSONIC, SONICBOOM, THUNDER_WAVE
	db 34, SKARMORY,  BERRY, DRILL_PECK, SPIKES, STEEL_WING, WHIRLWIND
	db 35, SCIZOR,    BERRY, METAL_CLAW, PURSUIT, ROCK_SMASH, QUICK_ATTACK
	db 36, STEELIX,   METAL_COAT, CURSE, SUNNY_DAY, DIG, IRON_TAIL
	db -1 ; end

ChuckGroup:
	; CHUCK (1)
	db "CHUCK@", TRAINERTYPE_ITEM_MOVES
	db 31, PRIMEAPE,   BERRY, LEER, RAGE, KARATE_CHOP, THUNDERPUNCH
	db 31, HERACROSS,  BERRY, STRENGTH, ROCK_SMASH, WING_ATTACK, SWORDS_DANCE
	db 32, HITMONTOP,  BLACKBELT_I, RAPID_SPIN, ROLLING_KICK, PURSUIT, SWORDS_DANCE
	db 33, POLIWRATH,  MIRACLEBERRY, HYPNOSIS, RAIN_DANCE, WATERFALL, DYNAMICPUNCH
	db -1 ; end

ClairGroup:
	; CLAIR (1)
	db "CLAIR@", TRAINERTYPE_ITEM_MOVES
	db 38, GYARADOS,   DRAGON_SCALE, RAIN_DANCE, WATERFALL, THUNDER, DRAGONBREATH
	db 39, DRAGONAIR,  MYSTIC_WATER, THUNDER_WAVE, SURF, THUNDER, DRAGONBREATH
	db 39, DRAGONAIR,  GOLD_BERRY, WHIRLPOOL, THUNDER, RAIN_DANCE , DRAGONBREATH
	db 39, DRAGONAIR,  GOLD_BERRY, SURF, ICE_BEAM, RAIN_DANCE, DRAGONBREATH
	db 40, KINGDRA,    DRAGON_FANG, SMOKESCREEN, SURF, HYPER_BEAM, DRAGONBREATH
	db -1 ; end
...
Rival1Group:
	...
	db 20, HAUNTER,    LICK, HEX, MEAN_LOOK, CURSE
	...
	db 35, KADABRA,    CONFUSION, PSYBEAM, RECOVER, FUTURE_SIGHT
...
WillGroup:
	...
	db 40, GIRAFARIG,  NASTY_PLOT, AGILITY, BATON_PASS, PSYCHIC_M
	db 41, ESPEON,     MORNING_SUN, FUTURE_SIGHT, SHADOW_BALL, PSYCHIC_M
	db 41, SLOWKING,   AMNESIA, FLAMETHROWER, SURF, PSYCHIC_M
	db 41, SLOWBRO,    CURSE, AMNESIA, BODY_SLAM, PSYCHIC_M
	db 42, XATU,       AIR_SLASH, FUTURE_SIGHT, CONFUSE_RAY, PSYCHIC_M
	db -1 ; end
...
KarenGroup:
	...
	db 42, UMBREON,    DOUBLE_TEAM, BATON_PASS, FAINT_ATTACK, MOONLIGHT
	db 42, VILEPLUME,  SLEEP_POWDER, GIGA_DRAIN, LEECH_SEED, SUBSTITUTE
	db 45, GENGAR,     SHADOW_BALL, HEX, CURSE, DESTINY_BOND
...
KogaGroup:
	...
	db 40, ARIADOS,    DOUBLE_TEAM, SWORDS_DANCE, BATON_PASS, LEECH_LIFE
	db 41, VENOMOTH,   BUG_BUZZ, SLUDGE_BOMB, PSYCHIC_M, TOXIC
	db 43, QWILFISH,   PROTECT, TOXIC, SURF, SLUDGE_BOMB 
	db 42, MUK,        MINIMIZE, ACID_ARMOR, SLUDGE_BOMB, TOXIC
	db 44, CROBAT,     DOUBLE_TEAM, ACID, WING_ATTACK, TOXIC
	db -1 ; end

ChampionGroup:
	; CHAMPION (1)
	db "LANCE@", TRAINERTYPE_MOVES
	db 44, GYARADOS,   FLAIL, RAIN_DANCE, SURF, GIGA_IMPACT
	db 47, DRAGONITE,  THUNDER_WAVE, TWISTER, THUNDER, GIGA_IMPACT
	db 47, DRAGONITE,  THUNDER_WAVE, TWISTER, BLIZZARD, GIGA_IMPACT
	db 46, AERODACTYL, WING_ATTACK, ANCIENTPOWER, ROCK_SLIDE, GIGA_IMPACT
	db 46, CHARIZARD,  FLAMETHROWER, WING_ATTACK, SLASH, HYPER_BEAM
	db 50, DRAGONITE,  FIRE_BLAST, SAFEGUARD, OUTRAGE, GIGA_IMPACT
	db -1 ; end
...
MistyGroup:
	...
	db 42, GOLDUCK,    SURF, AMNESIA, PSYCH_UP, PSYCHIC_M
...
LtSurgeGroup:
	...
	db 40, MAGNETON,   THUNDERBOLT, DOUBLE_TEAM, SWIFT, ZAP_CANNON
	db 40, ELECTRODE,  SCREECH, DOUBLE_TEAM, SWIFT, EXPLOSION
...
SchoolboyGroup:
	...
	db 35, GROWLITHE,  SUNNY_DAY, LEER, PLAY_ROUGH, FLAME_WHEEL
	...
	db 35, XATU,       PECK, SHADOW_SNEAK, SWIFT, FUTURE_SIGHT
	...
	db 38, MAGNETON,   FLASH, THUNDER_WAVE, THUNDERBOLT, SWIFT
	db -1 ; end
...
LassGroup:
	...
	db 18, PSYDUCK,    SCRATCH, TAIL_WHIP, AMNESIA,CONFUSION
	db -1 ; end
	...
	db 21, PSYDUCK,    SCRATCH, TAIL_WHIP, WATER_GUN, CONFUSION
	db -1 ; end

	; LASS (15)
	db "DANA@", TRAINERTYPE_MOVES
	db 29, PSYDUCK,    SCRATCH, WATER_GUN, CONFUSION, SCREECH
	db 29, AMPHAROS,   TACKLE, THUNDERSHOCK, THUNDER_WAVE, COTTON_SPORE
	db -1 ; end

	; LASS (16)
	db "DANA@", TRAINERTYPE_MOVES
	db 32, PSYDUCK,    SCRATCH, AMNESIA, CONFUSION, SCREECH
	...
	db 36, GOLDUCK,    AMNESIA, SURF, PSYCHIC_M, SCREECH
	db -1 ; end
...
JanineGroup:
	...
	db 36, WEEZING,    SMOG, SLUDGE_BOMB, TOXIC, EXPLOSION
	db 33, ARIADOS,    SCARY_FACE, GIGA_DRAIN, STRING_SHOT, SHADOW_SNEAK
...
CooltrainerMGroup:
	...
	db 35, KINGLER,    BUBBLEBEAM, STOMP, HARDEN, PROTECT
	...
	db 39, KINGLER,    KINGS_ROCK,   SURF, STOMP, HARDEN, BLIZZARD
	...
	db 32, KINGLER,    BUBBLEBEAM, STOMP, HARDEN, PROTECT
...
BugCatcherGroup:
	...
	db 28, VENOMOTH, GIGA_DRAIN, SUPERSONIC, CONFUSION, LEECH_LIFE
	db -1 ; end
	...
	db 25, BEEDRILL,   FURY_ATTACK, HARDEN, TWINEEDLE, RAGE
...
FisherGroup:
	...
	db 25, REMORAID,   FLAMETHROWER, PSYBEAM, AURORA_BEAM, BUBBLEBEAM
	db 25, REMORAID,   FLAMETHROWER, PSYBEAM, AURORA_BEAM, BUBBLEBEAM
	db -1 ; end
	...
	db 34, SEAKING,    SUPERSONIC, RAIN_DANCE, WATERFALL, FURY_ATTACK
	db 37, QWILFISH,   ROLLOUT, SURF, PIN_MISSILE, MINIMIZE
	db -1 ; end
...
SwimmerFGroup:
	...
	db 20, PSYDUCK,    SCRATCH, TAIL_WHIP, WATER_GUN, CONFUSION
...
Rival2Group:
	...
	db 43, ALAKAZAM,   PSYBEAM, RECOVER, FUTURE_SIGHT, PSYCHIC_M
...
HikerGroup:
	...
	db 35, PILOSWINE,  EARTHQUAKE, BLIZZARD, REST, ROCK_SLIDE
...
BurglarGroup:
	...
	db 26, GROWLITHE,  ROAR, EMBER, LEER, PLAY_ROUGH
...
BlackbeltGroup:
	...
	db 27, HITMONLEE,  DOUBLE_KICK, MEDITATE, JUMP_KICK, MACH_PUNCH
	db -1 ; end
	...
	db 25, MACHOP,     LEER, LOW_KICK, KARATE_CHOP, SEISMIC_TOSS
...
PsychicGroup:
	...
	db 17, DROWZEE,    HYPNOSIS, CONFUSION, DREAM_EATER, NO_MOVE
	db -1 ; end
	...
	db 24, NATU,       LEER, SHADOW_SNEAK, FUTURE_SIGHT, CONFUSE_RAY
	db 26, KADABRA,    CONFUSION, PSYBEAM, RECOVER, FUTURE_SIGHT
	db -1 ; end
...
CamperGroup:
	...
	db 34, GOLDUCK,    AMNESIA, PSYCHIC_M, SURF, PSYCH_UP
	db -1 ; end
...
ExecutiveFGroup:
	...
	db 32, MURKROW,    PECK, PURSUIT, HAZE, SHADOW_SNEAK
	db -1 ; end
...
TwinsGroup:
	...
	db 16, JIGGLYPUFF, SING, DEFENSE_CURL, POUND, PERISH_SONG
	db -1 ; end

	; TWINS (3)
	db "ANN & ANNE@", TRAINERTYPE_MOVES
	db 16, JIGGLYPUFF, SING, DEFENSE_CURL, POUND, FAINT_ATTACK
	db 16, CLEFAIRY,   GROWL, ENCORE, DOUBLESLAP, METRONOME
	db -1 ; end
...
BlueGroup:
	...
	db 54, ALAKAZAM,   PSYBEAM, RECOVER, PSYCHIC_M, REFLECT
...
MysticalmanGroup:
	...
	db 23, DROWZEE,    DREAM_EATER, HYPNOSIS, LIGHT_SCREEN, CONFUSION
