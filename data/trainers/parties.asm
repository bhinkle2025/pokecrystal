...
FalknerGroup:
	...
	db 12, NATU,      PECK, LEER, SHADOW_SNEAK, NO_MOVE
	db 12, PIDGEOTTO, MUD_SLAP, SAND_ATTACK, GUST, PURSUIT
	db 14, NOCTOWL,   PECK, MUD_SLAP, CONFUSION, GROWL
	db -1 ; end

WhitneyGroup:
	; WHITNEY (1)
	db "WHITNEY@", TRAINERTYPE_MOVES
	db 21, JIGGLYPUFF,   ICE_PUNCH, SING, DEFENSE_CURL, DOUBLESLAP
	db 21, TEDDIURSA,  FURY_SWIPES, LEER, LICK, ROCK_SMASH 
...
BugsyGroup:
	...
	db 18, PINECO,   SELFDESTRUCT, PIN_MISSILE, RAPID_SPIN, NO_MOVE
	db 18, LEDIAN,     LIGHT_SCREEN, REFLECT, MACH_PUNCH, THUNDERPUNCH
	db 21, SCYTHER,    QUICK_ATTACK, SWORDS_DANCE, FURY_CUTTER, CUT
	db -1 ; end

MortyGroup:
	; MORTY (1)
	db "MORTY@", TRAINERTYPE_MOVES
	db 26, HAUNTER,    HYPNOSIS, HEX, CURSE, SHADOW_BALL
	db 26, STANTLER,   HYPNOSIS, STOMP, SHADOW_BALL, DREAM_EATER
	db 28, MISDREAVUS, PSYBEAM, SHADOW_BALL, PERISH_SONG, HEX
	db 29, GENGAR,     HYPNOSIS, SHADOW_BALL, DREAM_EATER, NASTY_PLOT
	db -1 ; end

PryceGroup:
	; PRYCE (1)
	db "PRYCE@", TRAINERTYPE_MOVES
	db 36, DELIBIRD,   PRESENT, ICE_PUNCH, AMNESIA, RECOVER
	db 36, DEWGONG,    HEADBUTT, ICY_WIND, ICE_BEAM, REST
	db 36, JYNX,       LOVELY_KISS, CONFUSION, BLIZZARD, NASTY_PLOT
	db 37, SNEASEL,    ICE_PUNCH, FAINT_ATTACK, SWORDS_DANCE, ROCK_SMASH
	db 38, PILOSWINE,  ICY_WIND, FURY_ATTACK, DIG, BLIZZARD
	db -1 ; end
...
JasmineGroup:
	...
	db 34, SKARMORY,  DRILL_PECK, SPIKES, STEEL_WING, WHIRLWIND
	db 35, SCIZOR,    METAL_CLAW, PURSUIT, ROCK_SMASH, QUICK_ATTACK
	db 36, STEELIX,    CURSE, SUNNY_DAY, DIG, IRON_TAIL
	db -1 ; end

ChuckGroup:
	; CHUCK (1)
	db "CHUCK@", TRAINERTYPE_MOVES
	db 31, PRIMEAPE,   LEER, RAGE, KARATE_CHOP, THUNDERPUNCH
	db 31, HERACROSS,  STRENGTH, ROCK_SMASH, WING_ATTACK, SWORDS_DANCE
	db 32, HITMONTOP,  RAPID_SPIN, ROLLING_KICK, PURSUIT, SWORDS_DANCE
	db 33, POLIWRATH,  HYPNOSIS, MIND_READER, WATERFALL, DYNAMICPUNCH
	db -1 ; end

ClairGroup:
	; CLAIR (1)
	db "CLAIR@", TRAINERTYPE_MOVES
	db 38, GYARADOS,   RAIN_DANCE, WATERFALL, THUNDER, DRAGONBREATH
	db 39, DRAGONAIR,  THUNDER_WAVE, SURF, THUNDER, DRAGONBREATH
	db 39, DRAGONAIR,  WHIRLPOOL, THUNDER, RAIN_DANCE , DRAGONBREATH
	db 39, DRAGONAIR,  SURF, ICE_BEAM, RAIN_DANCE, DRAGONBREATH
