...
; Johto hidden items
	...
	const_skip ; unused in Crystal
	const_skip ; unused in Crystal
	const EVENT_NATIONAL_PARK_HIDDEN_SUN_STONE
	...
	const EVENT_GOLDENROD_UNDERGROUND_HIDDEN_THUNDERSTONE
	...
	const EVENT_ECRUTEAK_CITY_HIDDEN_WATER_STONE
...
; Kanto hidden items
	...
	const EVENT_BURNED_TOWER_1F_HIDDEN_FIRE_STONE
...
; New to Crystal
	...
	const EVENT_GOT_YOUNGSTER_POKEMON
	const EVENT_ELM_GAVE_FINAL_STARTER
	const EVENT_CAN_TAKE_FINAL_STARTER
